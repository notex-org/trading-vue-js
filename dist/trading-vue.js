  ...
  methods: {
    ...
    tool: function tool() {
      return {
        // Descriptor for the tool
        //group: "HLines",
        icon: icons_namespaceObject["hline.png"],
        type: "Extended",
        hint: "This hint will be shown on hover",
        data: [],
        // Default data
    ...
    draw: function draw(ctx) {
      ...
      ctx.fillText(this.p1[1], x + 10, y - 4);
      this.render_pins(ctx);
    },
    use_for: function use_for() {
      return ["HLineTool"];
  ...
  methods: {
    ...
    tool: function tool() {
      return {
        // Descriptor for the tool
        //group: "VLines",
        icon: icons_namespaceObject["vline.png"],
        type: "Extended",
        hint: "This hint will be shown on hover",
        data: [],
        // Default data
